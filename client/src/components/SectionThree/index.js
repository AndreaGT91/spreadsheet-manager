...
//           <p style={{fontSize: 'calc(1vw + 10px)'}}>
//             Easily store and retrieve data from anywhere<br></br>Online and Offline.
//           </p>
//         </Container>
//       </Jumbotron>
//     )
        ...
        {(progress) => (
          <Timeline totalProgress={progress} paused>
            ...
            <Tween
              ...
              from={{ opacity: 1, x: '55%', top:'10%', rotation:360 ,scale: 1.5, }}
              to={{ opacity: 0, x: '55%', top: '10%', duration: 1, scale: .5, }}
            >
